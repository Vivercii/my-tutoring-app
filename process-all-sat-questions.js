...
// Parse question to extract passage and question
function parseQuestion(fullText, htmlText) {
    ...
    // For dual-text or fill-in-blank, adjust threshold
...
function main() {
    ...
    const outputPath = process.argv[3] || 'sat_questions_processed.json';
    const outputDir = process.argv[4] || 'sat_questions_by_test';
    ...
    try {
        ...
        console.log('You can now use these JSON files in your application.');
